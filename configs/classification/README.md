# Image Classification Configuration instructions
We have prepared two configuration files for you in configs/[complete.yaml](complete.yaml), [pet.yaml](pet.yaml), you could modify based on your own task.

The meaning of each parameter setting as below
* model
```markdown
model:
